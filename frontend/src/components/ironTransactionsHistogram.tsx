...
export function IronTransactionsHistogram() {
  ...
  const dailyData =
    data?.daily_summaries?.map((item) => {
      ...
      return {
        ...
        dateFull: item.date,
        totalTransactions: item.summary.total_transactions,
        onramps: item.summary.total_onramps,
        offramps: item.summary.total_offramps,
      }
    }) || []
